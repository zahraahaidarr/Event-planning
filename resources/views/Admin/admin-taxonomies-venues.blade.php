  ...
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-section">
        ...
        <a href="{{ url('admin/volunteers') }}" class="nav-item">
          <span class="nav-icon">👥</span><span>Volunteers</span>
        </a>
        <a href="{{ url('admin/events') }}" class="nav-item">
          <span class="nav-icon">📅</span><span>Events</span>
        </a>
        <a href="{{ Route::has('admin.taxonomies-venues.index') 
                    ? route('admin.taxonomies-venues.index') 
                    : url('admin/taxonomies-venues') }}"
      ...
      <nav class="nav-section">
        ...
        <a href="{{ url('profile') }}" class="nav-item"><span class="nav-icon">👤</span><span>Profile</span></a>
        <a href="{{ url('settings') }}" class="nav-item"><span class="nav-icon">🔧</span><span>Settings</span></a>
      </nav>
    </aside>
