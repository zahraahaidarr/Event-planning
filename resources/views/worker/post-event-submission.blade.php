{{-- resources/views/worker/post-event-submission.blade.php --}}
<!doctype html>
...
<head>
    ...
    <title>Post-Event Submissions • VolunteerHub</title>
...
<body>
<div class="container">
    {{-- =================== SIDEBAR (SAME AS DISCOVER EVENTS) =================== --}}
<aside class="sidebar">
    @php
        $user = Auth::user();
    ...
    @endphp
        ...
        <nav class="nav-section">
            {{-- same structure as Discover Events --}}
...
<div class="form-group">
    ...
    <select
        id="eventSelect"
        name="worker_reservation_id"
        required
        data-reservations='@json($reservationOptions)'>
...
@php
$submissionsPayload = $submissions->map(function ($sub) {
    ...
    return [
        'id'                    => $sub->id,
        'worker_reservation_id' => $sub->worker_reservation_id,
        'role_slug'             => $sub->role_slug,
        'event_name'            => $eventName,
...
<section>
    ...
    {{-- JS will render the cards here --}}
    <div
        class="list"
        id="submissionsList"
        data-submissions='@json($submissionsPayload)'>
    </div>
</section>
